...
An array a
is good if for all pairs of adjacent elements, ai and ai+1 (1≤i<n) are of different parity. Note that an array of size 1
...
-nd and the 3-rd integers and apply the operation on them. The array changes from [1,7,11,2,13] to [1,77,2,13]. Next, select the 1-st and the 2-nd integers, array changes from [1,77,2,13] to [77,2,13]. Thus we require 2
