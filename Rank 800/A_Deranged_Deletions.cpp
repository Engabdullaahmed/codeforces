...
from the array so that it becomes [4,5,2,4]. It can be shown this array is a derangement. This is not the only solution – it can be shown that the original array [4,5,5,2,4] is another valid solution.*/
int main()
{
