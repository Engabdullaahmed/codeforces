...
. Given two integers l and r, for all 1≤i≤n such that l≤ai≤r, set ai:=ai+1
.
- l r
. Given two integers l and r, for all 1≤i≤n such that l≤ai≤r, set ai:=ai−1
...
, after performing the operation + 2 4, the array a=[7,1,4,5,4]. Then, after performing the operation - 1 10, the array a=[6,0,3,4,3]
...
and m (1≤n≤105, 1≤m≤105

) — the length of the array and the number of operations.

The second line of each test case contains n
integers a1,a2,…,an (1≤ai≤109) — the initial array a

.

Then m
lines follow, each line corresponds to the operation, in the following format: c l r (c∈{+,-}, l and r are integers, 1≤l≤r≤109
...
over all test cases does not exceed 105, and the sum of m over all test cases does not exceed 105

.
Output

For each test case, output one single line containing m
integers, with the i-th of them describing the maximum value of the array after the i
