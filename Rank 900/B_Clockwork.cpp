...
time clocks arranged in a line, where the initial time on the i-th clock is ai
...
becomes [3,9,4]. You move to clock 2 and reset its time, resulting in a=[3,10,4]
.
a
becomes [2,9,3]. You move to clock 3 and reset its time, resulting in a=[2,9,5]
.
a
becomes [1,8,4]. You move to clock 2 and reset its time, resulting in a=[1,10,4]
.
a
becomes [0,9,3]. You move to clock 1, but you lose because a1 reaches 0
